...
|cm^2|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|cm^2|None|
...
|episode|http://cardinalkit.org/fhir/CodeSystem/descriptive-statistic-denominator|episode|None|
...
|g|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|g|None|
...
|laryngeal|http://cardinalkit.org/fhir/CodeSystem/intervention-administration-route|laryngeal|None|
|lb|http://unitsofmeasure.org|[lb_av]|pound (US and British)|
|left ankle|http://cardinalkit.org/fhir/CodeSystem/body-location|left ankle|None|
|left hip|http://cardinalkit.org/fhir/CodeSystem/body-location|left hip|None|
|left thigh|http://cardinalkit.org/fhir/CodeSystem/body-location|left thigh|None|
|left thorax|http://cardinalkit.org/fhir/CodeSystem/body-location|left thorax|None|
|left upper arm|http://cardinalkit.org/fhir/CodeSystem/body-location|left upper arm|None|
|left wrist|http://cardinalkit.org/fhir/CodeSystem/body-location|left wrist|None|
...
|meal|http://cardinalkit.org/fhir/CodeSystem/descriptive-statistic-denominator|meal|None|
|mg|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|mg|None|
|mg/actuat|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|mg/actuat|None|
|mg/dL|http://unitsofmeasure.org|mg/dL|milligram per deciliter|
|mg/hr|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|mg/hr|None|
|mg/mL|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|mg/mL|None|
|mg/mg|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|mg/mg|None|
|mi|http://unitsofmeasure.org|[mi_i]|statute mile|
|mi^2|http://unitsofmeasure.org|[smi_i]|None|
|middle left thorax|http://cardinalkit.org/fhir/CodeSystem/body-location|middle left thorax|None|
...
|mmol|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|mmol|None|
|mmol/L|http://unitsofmeasure.org|mmol/L|millimole per liter|
|mol|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|mol|None|
...
|ng|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|ng|None|
|night|http://snomed.info/sct|2546009|on - omni nocte|
|nm|http://unitsofmeasure.org|nm|nanometer|
|nmol|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|nmol|None|
...
|right ankle|http://cardinalkit.org/fhir/CodeSystem/body-location|right ankle|None|
|right hip|http://cardinalkit.org/fhir/CodeSystem/body-location|right hip|None|
|right thigh|http://cardinalkit.org/fhir/CodeSystem/body-location|right thigh|None|
|right upper arm|http://cardinalkit.org/fhir/CodeSystem/body-location|right upper arm|None|
|right wrist|http://cardinalkit.org/fhir/CodeSystem/body-location|right wrist|None|
...
|session|http://cardinalkit.org/fhir/CodeSystem/descriptive-statistic-denominator|session|None|
|sitting|http://snomed.info/sct|33586001|Sitting position|
|soft tissue|http://cardinalkit.org/fhir/CodeSystem/intervention-administration-route|soft tissue|None|
...
|ug|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|ug|None|
|ug/mL|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|ug/mL|None|
|um|http://unitsofmeasure.org|um|micrometer|
|umol|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|umol|None|
|unt|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|unt|None|
|unt/mL|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|unt/mL|None|
|us|http://unitsofmeasure.org|us|microsecond|
|vial|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|vial|None|
|wafer|http://cardinalkit.org/fhir/CodeSystem/medication-dose-unit|wafer|None|
